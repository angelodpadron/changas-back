...
public class DeclinedByRequesterHandler extends TransactionStatusHandler {
    private final TransactionStatus statusToHandle = TransactionStatus.DECLINED_BY_REQUESTER;
    @Override
    ...
    public void handleTransaction(HiringTransaction transaction, TransactionResponse response, Customer customer) throws IllegalTransactionOperationException {
        ...
        throw new IllegalTransactionOperationException("The transaction has been declined by the requester and cannot longer be operated");
    }
}
